...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position title:(NSString *)title style:(CSToastStyle *)style completion:(void(^)(BOOL didTap))completion {
    UIView *toast = [self toastViewForMessage:message title:title style:style];
    [self showToast:toast duration:duration position:position completion:completion];
}

- (UIView *)toastViewForMessage:(NSString *)message title:(NSString *)title style:(CSToastStyle*)style {
...
- (void)cs_handleToastTapped: (UITapGestureRecognizer *)sender {
...
@property (nonatomic, strong) CSToastStyle * sharedStyle;
